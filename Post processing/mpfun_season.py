...
# Function to calculate yearly AE from basin-level stage time series
def AE(wse_year):
...
# Function to calculate change rates of seasonal metrics based on the developed basin-level time series
